...
export default function CurrentlyRoute({ location }: { location: locationData }) {
type WeatherData = {
    temperature: number;
    windspeed: number;
    weathercode: number;
    ...
    return (
        <View style={styles.tabBackground}>
            <View >
                ...
                <Text style={styles.tabText}>{location?.city ?? 'Unknown'}</Text>
                <Text style={styles.tabText}>Temperature: {weather?.temperature ?? 'Unknown'}</Text>
                <Text style={styles.tabText}>Wind Speed: {weather?.windspeed ?? 'Unknown'}</Text>
                <Text style={styles.tabText}>Weather Code: {weather?.weathercode ?? 'Unknown'}</Text>
            </View>
        </View>
    );
}
